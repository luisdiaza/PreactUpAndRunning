This app introduced me to Webpack & Babel and taught me how to configure these tools for use with Preact. I then learned how to create components and how the Preact API mirrors that of React and noted the differences/additions along the way. Finally, I looked at the interoperability with existing popular libraries in the React community such as Redux & React Router and with the popular development tools such as Redux Dev Tools & React Dev-Tools
